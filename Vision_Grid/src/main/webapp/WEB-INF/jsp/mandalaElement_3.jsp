...
<head>
    <meta charset="UTF-8">
    <title>Vision Grid | E3 ACTIONS</title>
    <!-- Fonts -->
...
<body>
    <div class="wrapper">
        ...
        <main>
            <h2 class="page-title">E3 ACTIONS SETTING</h2>
            ...
            <p class="align-center">
                ...
                <span class="marker-effect">要素3: <c:out value="${elementKeysList[2]}" /> </span>に対してのアクション
            </p>

            <img src="${pageContext.request.contextPath}/images/gridsheet_sample/e3-actions.png" alt="目標シートサンプル画像(E3actions)" class="mandala-img">
            ...
            <div class="elements-actions-setting mandala-form">
                <form action="MandalaE3ActionServlet" method="post">
                    <!-- アクションA〜Hの入力欄 -->
                    <c:forEach var="letter" items="A,B,C,D,E,F,G,H">
                        <div class="form-section">
                            ...
                            <div class="form-group" >
                                <div>
                                    <input type="text" id="e3${letter}Key" name="e3${letter}Key" placeholder="アクション${letter}を入力" required>
                                </div>
                                <div>
                                    <textarea id="e3${letter}Text" name="e3${letter}Text" placeholder="アクション${letter}の詳細を入力" ></textarea>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
