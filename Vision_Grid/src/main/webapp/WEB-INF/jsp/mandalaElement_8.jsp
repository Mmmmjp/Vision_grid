...
<head>
    <meta charset="UTF-8">
    <title>Vision Grid | E8 ACTIONS</title>
    <!-- Fonts -->
...
<body>
    <div class="wrapper">
        ...
        <main>
            <h2 class="page-title">E8 ACTIONS SETTING</h2>
            ...
            <p class="align-center">
                ...
                <span class="marker-effect">要素8: <c:out value="${elementKeysList[7]}" /></span> に対してのアクション
            </p>

            <img src="${pageContext.request.contextPath}/images/gridsheet_sample/e8-actions.png" alt="目標シートサンプル画像(E8actions)" class="mandala-img">
            ...
            <div class="elements-actions-setting mandala-form">
                <form action="MandalaE8ActionServlet" method="post">
                    <!-- アクションA〜Hの入力欄 -->
                    <c:forEach var="letter" items="A,B,C,D,E,F,G,H">
                        <div class="form-section">
                            ...
                            <div class="form-group" >
                                <div>
                                    <input type="text" id="e8${letter}Key" name="e8${letter}Key" placeholder="アクション${letter}を入力" required>
                                </div>
                                <div>
                                    <textarea id="e8${letter}Text" name="e8${letter}Text" placeholder="アクション${letter}の詳細を入力" ></textarea>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
