        ...
        <main>
            ...
            <div class="wrapper-center">
                <section class="intro-section">
                    ...
                    <p>マンダラチャートとは、目標やアイデアを整理し、具体的な行動計画を立てるためのツールです。メジャーリーグで活躍する大谷翔平選手が、学生時代に取り組んでいたことでも話題になりました。<br>
                        中心に大きな目標を置き、その周りに関連する8つの要素を配置します。さらにそれぞれの要素を細分化して具体的なタスクに落とし込むことで、目標達成に必要な手順を視覚的に整理できます。この方法は、全体像を把握しつつ細かい部分まで具体的に考えられる点が特徴です。
                    </p>
                ...
                <section class="intro-section">
                    <h3 class="intro-title">作成時のポイント</h3>
                    <p>
                        抽象的な内容は控えて、できる限り具体的な目標を書くことがポイントです。要素や、要素に対してのアクションがなかなか埋まらないという場合には一度に作成を完成させる必要はありません。また時間をおいてログインし作成をしてみてください。
                    </p>
                </section>
